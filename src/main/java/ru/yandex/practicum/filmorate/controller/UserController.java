...
public class UserController {
    ...
    public Set<User> getFriendsByUserId(@PathVariable("id") Long userId) {
    ...
    public Set<User> getCommonFriendsByUserId(@PathVariable("id") Long userId, @PathVariable("otherId") Long otherUserId) {
